...
const pageTitle = "Ear Piercing Chart: Pain, Healing Time, Placement & Jewelry Guide";
...
const pageJsonLd = [
  ...
  }),
  {
    ...
    url: absoluteUrl("/ear-piercing-chart/"),
  ...
  breadcrumbJsonLd([{ name: "Ear Piercing Chart", path: "/ear-piercing-chart/" }]),
];
...
export default function EarPiercingChartPage() {
  return (
    <main>
